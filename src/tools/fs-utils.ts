 ...
 * workspace scoping.
 */
export function isInsideWorkspace(resolvedPath: string, workspaceRoot: string): boolean {
...
export async function writeFileDirect(path: string, content: string): Promise<void> {
